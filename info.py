...
PICS = (environ.get('PICS' ,'https://graph.org/file/9d4a31e31a4b274593c50.jpg https://graph.org/file/38087153ae158f01004d7.jpg')).split()
UPTIME = time.time()
...
syd_channel = environ.get('AUTH_CHANNEL')
sud_channel = environ.get('AUTH_CHANNEL')
